...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='', help='finetune from checkpoint')  # Here xxx.pth

    # Dataset parameters
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='WDF', choices=['WDF', 'CIFAR', 'IMNET', 'INAT', 'INAT19'],
...
def main(args):
    ...
    if args.eval:
        print('===============================TEST===============================')
        test_stats, df_test = evaluate(data_loader_val, model, device)
    ...
    max_accuracy = 0.0
    best_epoch = -1
    # print('args.output_dir: ', args.output_dir, '  type(args.output_dir): ', type(args.output_dir))
